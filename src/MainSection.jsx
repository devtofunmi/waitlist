...
const MainSection = () => {
  return (
    ...
    <div className="flex justify-center items-center flex-col text-white mt-20">
      <h2 className="md:text-5xl text-4xl font-bold text-center leading-[50px] md:leading-[55px]">
      ...
      <div className="md:w-[400px] md:h-[150px] w-[300px] h-[200px] bg-[#282a3e] flex flex-col items-center rounded-lg mt-10">
